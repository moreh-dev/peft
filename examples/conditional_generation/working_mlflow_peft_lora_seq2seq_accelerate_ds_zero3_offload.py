...
def main(args):
    ...
    experiment_id = mlflow.create_experiment('conditional_generation-{}'.format(args.model_name_or_path))
    ...
    train_dataloader = DataLoader(
        train_dataset, shuffle=True, collate_fn=collate_fn, batch_size=args.batch_size, pin_memory=True
    )
    eval_dataloader = DataLoader(eval_dataset, collate_fn=collate_fn, batch_size=args.batch_size, pin_memory=True)
    test_dataloader = DataLoader(test_dataset, collate_fn=collate_fn, batch_size=args.batch_size, pin_memory=True)
    ...
    # model.push_to_hub(
    #     "smangrul/"
    #     + f"{dataset_name}_{args.model_name_or_path}_{peft_config.peft_type}_{peft_config.task_type}".replace("/", "_"),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", type=str, default="bigscience/T0_3B", help="Model name or path")
